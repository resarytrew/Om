(() => {
  ...
  const els = {
    u:$('#uSlider'),r:$('#rSlider'),uVal:$('#uValue'),rVal:$('#rValue'),iVal:$('#iValue'),badge:$('#currentBadge'),digital:$('#digital'),voltmeter:$('#voltmeterDigital'),needle:$('#needle'),
  ...
  function update(renderPanel=true){
    ...
    els.badge.querySelector('span').textContent='I = '+clean(i,2)+' А';els.digital.textContent=i.toFixed(2)+' A';els.voltmeter.textContent=state.U.toFixed(1)+' V';els.needle.setAttribute('transform',`rotate(${needleAngle(i)} 712 351)`);
